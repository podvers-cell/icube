module.exports = [
"[project]/src/views/DashboardPackages.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DashboardPackages() {
    ...
    function load() {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/dashboard/packages").then(setList).catch(()=>{});
    }
    ...
    async function save(e) {
        ...
        try {
            if (editing.id === 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/dashboard/packages", editing);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].put(`/dashboard/packages/${editing.id}`, editing);
            }
            setEditing(null);
            load();
        } catch (err) {
    ...
    async function remove(id) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/dashboard/packages/${id}`);
            load();
        } catch (err) {
            alert(err instanceof Error ? err.message : "Failed");
        }
...
//# sourceMappingURL=_dbcc48b3._.js.map