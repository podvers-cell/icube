module.exports = [
"[project]/src/views/DashboardPortfolio.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DashboardPortfolio() {
    ...
    function load() {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/dashboard/portfolio").then(setList).catch(()=>{});
    }
    ...
    async function save(e) {
        ...
        try {
            if (editing.id === 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/dashboard/portfolio", {
                    title: editing.title,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].put(`/dashboard/portfolio/${editing.id}`, editing);
            }
            setEditing(null);
            load();
        } catch (err) {
    ...
    async function remove(id) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/dashboard/portfolio/${id}`);
            load();
        } catch (err) {
            alert(err instanceof Error ? err.message : "Failed");
        }
...
//# sourceMappingURL=_ca55b58d._.js.map