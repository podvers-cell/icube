...
"[project]/src/views/DashboardStudios.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function textToImages(text) {
    return text.split("\n").map((s)=>s.trim()).filter(Boolean).map((image_url)=>({
            image_url
        }));
}
function DashboardStudios() {
    _s();
    ...
    function load() {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/dashboard/studios").then(setList).catch(()=>{});
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardStudios.useEffect": ()=>load()
    }["DashboardStudios.useEffect"], []);
    const sorted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardStudios.useMemo[sorted]": ()=>[
                ...list
            ].sort({
                "DashboardStudios.useMemo[sorted]": (a, b)=>(a.sort_order ?? 0) - (b.sort_order ?? 0)
            }["DashboardStudios.useMemo[sorted]"])
    }["DashboardStudios.useMemo[sorted]"], [
        list
    ]);
    ...
    function openEdit(s) {
        ...
        setEditing({
            ...s,
            imagesText: imagesToText(s.images)
        });
    }
    async function save(e) {
        ...
        try {
            if (creating) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/dashboard/studios", payload);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/dashboard/studios/${editing.id}`, payload);
            }
            setEditing(null);
            load();
        } catch (err) {
    ...
    async function remove(id) {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/dashboard/studios/${id}`);
            load();
        } catch (err) {
            alert(err instanceof Error ? err.message : "Failed");
        }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Studios Gallery"
                    }, void 0, false, {
                        fileName: "[project]/src/views/DashboardStudios.tsx",
                        lineNumber: 107,
                        columnNumber: 9
                    }, this),
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-icube-gold text-sm mt-2",
                                        children: [
            ...
            editing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-icube-gray border border-white/10 rounded-sm p-6 max-w-2xl w-full space-y-4 overflow-y-auto max-h-[90vh]",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "text-xl font-display font-bold text-white",
                            children: creating ? "Add Studio" : "Edit Studio"
                        }, void 0, false, {
                            fileName: "[project]/src/views/DashboardStudios.tsx",
                            lineNumber: 147,
                            columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            onChange: (e)=>setEditing((x)=>x ? {
                                                        ...x,
                                                        price_aed_per_hour: Number(e.target.value)
                                                    } : null),
                                            className: "w-full bg-black/50 border border-white/10 p-3 rounded-sm text-white"
                                        }, void 0, false, {
                                            fileName: "[project]/src/views/DashboardStudios.tsx",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    className: "block text-sm text-gray-400 mb-1",
                                    children: "Details (shown in popup)"
                                }, void 0, false, {
                                    fileName: "[project]/src/views/DashboardStudios.tsx",
                                    lineNumber: 216,
                                    columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    className: "block text-sm text-gray-400 mb-1",
                                    children: "Gallery images (one URL per line)"
                                }, void 0, false, {
                                    fileName: "[project]/src/views/DashboardStudios.tsx",
                                    lineNumber: 225,
                                    columnNumber: 15
...
_s(DashboardStudios, "6mAH7CME/DALdC6PK0pIOFRr770=");
_c = DashboardStudios;
var _c;
__turbopack_context__.k.register(_c, "DashboardStudios");
...
//# sourceMappingURL=_00140987._.js.map