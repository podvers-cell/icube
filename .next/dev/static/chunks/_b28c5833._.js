...
"[project]/src/views/DashboardMessages.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function createdAtDisplay(raw) {
    if (typeof raw === "string") return new Date(raw).toLocaleString("en-AE", {
        dateStyle: "medium",
        timeStyle: "short"
    });
    if (raw && typeof raw === "object") {
        if ("toDate" in raw && typeof raw.toDate === "function") return raw.toDate().toLocaleString("en-AE", {
            dateStyle: "medium",
            timeStyle: "short"
        });
        if ("seconds" in raw) return new Date(raw.seconds * 1000).toLocaleString("en-AE", {
            dateStyle: "medium",
            timeStyle: "short"
        });
    }
...
function DashboardMessages() {
    ...
    function load() {
        setLoading(true);
        setError(null);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/dashboard/messages").then((data)=>{
            setList(Array.isArray(data) ? data : []);
        }).catch(()=>setError("Failed to load messages")).finally(()=>setLoading(false));
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardMessages.useEffect": ()=>load()
    }["DashboardMessages.useEffect"], []);
    async function markRead(id) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patch(`/dashboard/messages/${id}/read`);
            load();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/views/DashboardMessages.tsx",
                        lineNumber: 62,
                        columnNumber: 9
                    }, this),
            ...
            loading && list.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                className: "bg-icube-gray border border-white/10 rounded-lg p-12 text-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$mail$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Mail$3e$__["Mail"], {
                        size: 48,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Messages from the site contact form will appear here (saved in Firebase)."
                    }, void 0, false, {
                        fileName: "[project]/src/views/DashboardMessages.tsx",
                        lineNumber: 89,
                        columnNumber: 11
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-2",
                        children: list.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>select(m),
                                className: `w-full text-left p-4 rounded-lg border transition-colors ${selected?.id === m.id ? "border-icube-gold bg-icube-gold/10" : "border-white/10 bg-icube-gray hover:border-white/20"}`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            !m.read_at && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-2 h-2 rounded-full bg-icube-gold shrink-0 mt-1.5"
                                            }, void 0, false, {
                                                fileName: "[project]/src/views/DashboardMessages.tsx",
                                                lineNumber: 105,
                                                columnNumber: 34
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-icube-gray border border-white/10 rounded-lg p-6 min-h-[200px]",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        selected.email,
                                        "> · ",
                                        createdAtDisplay(selected.created_at)
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/views/DashboardMessages.tsx",
                                    lineNumber: 115,
...
_s(DashboardMessages, "QhZEI8Xr/SN4yt1xX/AHkS7w0jo=");
_c = DashboardMessages;
var _c;
__turbopack_context__.k.register(_c, "DashboardMessages");
...
//# sourceMappingURL=_b28c5833._.js.map