    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ ...viewportTransition, delay: 0.08 }} className="text-3xl md:text-4xl lg:text-5xl font-display font-bold tracking-tight">
